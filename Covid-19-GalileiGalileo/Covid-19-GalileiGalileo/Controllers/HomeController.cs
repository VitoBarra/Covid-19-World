    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            try
            {
                ...
                worldHistory = new CovidList<CovidData>(RestServices.GetDataHistory(out hs).ToArray(), true);
            } catch 
            {
            ...
            try
            {
                foreach (CovidData CovidD in new CovidList<CovidData>(RestServices.GetStatByCountry(out http).ToArray()))
                {
        ...
        public IActionResult CovidStatistic(string Country = "all")
        {
            ...
            try
            {
                CovidList<CovidData> CountryHistory = new CovidList<CovidData>(RestServices.GetDataHistory(out hs, Country).ToArray(), true);
